    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="Create">服務</h5>
            </div>
            <div class="modal-body">
                <form method="post" role="form" id="service" class="form-horizontal service-form">
                    ...
                    <div class="form-service">
                        <label for='stype' class='col-sm-3 control-label'>類型: </label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-service">
                        <label for='ip' class='col-sm-3 control-label'>IP 位址: </label>
                        <div class="col-sm-9">
                            <input type='text' id='ip' name='ip' class='form-control has-feedback' placeholder='<?php echo $device['hostname']?>'/>
                        </div>
                    </div>
                    <div class="form-service">
                        <label for='param' class='col-sm-3 control-label'>參數: </label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-service">
                        <div class="col-sm-offset-3 col-sm-9">
                            <button class="btn btn-success btn-sm" type="submit" name="service-submit" id="service-submit" value="save">儲存服務</button>
                        </div>
                    </div>
