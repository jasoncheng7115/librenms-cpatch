...
<div class="table-responsive">
    <table id="alerts_'.$unique_id.'" class="table table-hover table-condensed alerts">
        <thead>
            <tr>
                <th data-column-id="status" data-formatter="status" data-sortable="false">狀態</th>
                <th data-column-id="rule">規則</th>
                <th data-column-id="details" data-sortable="false">&nbsp;</th>
                <th data-column-id="hostname">主機</th>
                <th data-column-id="timestamp">時間戳記</th>
                <th data-column-id="severity" data-formatter="severity">嚴重性</th>
                <th data-column-id="ack" data-formatter="ack" data-sortable="false">已知/確認</th>';
    if (is_numeric($proc)) {
        if ($proc) {
            $common_output[] = '<th data-column-id="proc" data-formatter="proc" data-sortable="false">處理</th>';
        }
    } else {
        $common_output[] = '<th data-column-id="proc" data-formatter="proc" data-sortable="false">處理</th>';
    }
