...
';
    ...
    echo '<i class="fa fa-microchip fa-lg icon-theme" aria-hidden="true"></i> <strong>處理器</strong></a>';
    echo '</div>
    ...
    if ($config['cpu_details_overview'] === false) {
        ...
        $graph_array['width']=210;
        $graph_array['height']=100;
        $overlib_content      = generate_overlib_content($graph_array, $device['hostname'].' - CPU 使用率');
