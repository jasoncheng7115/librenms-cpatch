    ...
    <table id="storage" class="table table-hover table-condensed storage">
        <thead>
            <tr>
                ...
                <th data-column-id="storage_descr">儲存</th>
                <th data-column-id="graph" data-sortable="false" data-searchable="false"></th>
                <th data-column-id="storage_used" data-searchable="false">已使用</th>
                <th data-column-id="storage_perc" data-searchable="false">使用率</th>
            </tr>
        </thead>
    </table>
</div>
