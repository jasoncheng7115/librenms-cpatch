    ...
    <table id="mempool" class="table table-hover table-condensed mempool">
        <thead>
            <tr>
                ...
                <th data-column-id="mempool_descr">記憶體</th>
                <th data-column-id="graph" data-sortable="false" data-searchable="false"></th>
                <th data-column-id="mempool_used" data-searchable="false">使用容量</th>
                <th data-column-id="mempool_perc" data-searchable="false">使用率</th>
            </tr>
        </thead>
    </table>
</div>
