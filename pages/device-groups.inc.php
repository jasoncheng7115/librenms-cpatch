...
if (!empty($group_count_check)) {
    ...
    echo '<table class="table table-condensed table-hover"><thead><tr>';
        echo '<th>名稱</th><th>說明</th><th>條件</th><th>操作</th>';
        echo '</tr></thead><tbody>';
    ...
    echo "<center>看起來尚未建立群組，您可以現在建立。請點選 <b>建立新群組</b> 按鈕來進行下一步。</center><br>";
    echo "<center><button type='button' class='btn btn-primary btn-sm' aria-label='Add' data-toggle='modal' data-target='#create-group' data-group_id='' name='create-device-group'>建立新群組</button></center>";
}
