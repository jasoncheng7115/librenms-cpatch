    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h5 class="modal-title" id="Create">裝置群組</h5>
        </div>
        ...
        <div class='form-group'>
            <label for='desc' class='col-sm-3 control-label'>說明: </label>
            <div class='col-sm-9'>
        ...
        <div class="form-group">
                <label for='pattern' class='col-sm-3 control-label'>對象: </label>
                <div class="col-sm-5">
                        <input type='text' id='suggest' name='pattern' class='form-control has-feedback' placeholder='例: devices.status'/>
                </div>
        </div>
        <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9">
                        <p>當您開始輸入時，系統會自動提示可用的關鍵字</p>
                </div>
        </div>
        <div class="form-group">
                <label for='condition' class='col-sm-3 control-label'>條件: </label>
                <div class="col-sm-5">
        ...
        <div class="form-group">
                <label for='group-glue' class='col-sm-3 control-label'>連接詞: </label>
                <div class="col-sm-5">
        ...
        <div class="form-group">
                <div class="col-sm-offset-3 col-sm-3">
                        <button class="btn btn-success btn-sm" type="submit" name="group-submit" id="group-submit" value="save">儲存群組</button>
                </div>
        </div>
</form>
                        </div>
...
$('#group-submit').click('', function(e) {
    ...
    $.ajax({
        ...
        error: function(){
            $("#message").html('<div class="alert alert-info">建立群組時發生錯誤。</div>');
            $("#create-group").modal('hide');
        }
    });
});
...
$( "#name, #suggest, #value" ).blur(function() {
    ...
    if (name == "") {
        ...
        $("#suggest").closest('.form-group').removeClass('has-error');
        $("#value").closest('.form-group').removeClass('has-error');
        $("#next-step-and").html('<i class="fa fa-long-arrow-left fa-col-danger"></i> 點選 AND / OR');
    }
});
