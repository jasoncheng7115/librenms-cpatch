...
<form method="post" action="" class="form-inline" role="form">
    <div class="form-group">
        <label for="package">套件</label>
        <input type="text" name="package" id="package" size=20 value="<?php echo($_POST['package']); ?>" class="form-control input-sm" placeholder="任何" />
    </div>
    <div class="form-group">
        <label for="version">版本</label>
        <input type="text" name="version" id="version" size=20 value="<?php echo($_POST['version']); ?>" class="form-control input-sm" placeholder="任何" />
    </div>
    <div class="form-group">
        <label for="version">架構</label>
        <input type="text" name="arch" id="arch" size=20 value="<?php echo($_POST['arch']); ?>" class="form-control input-sm" placeholder="任何" />
    </div>
...
<form method="post" action="search/search=packages/" id="result_form">
    <table class="table table-hover table-condensed table-striped">
        <tr>
            <td colspan="3"><strong>套件</strong></td>
